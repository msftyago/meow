...
---> Fan of GPL-3.0, Emacs enjoyer, Network wizard, 18
	...
	|    Daily drive: NixOS & Xinux
	|    Editor of choice: GNU Emacs (config)
	|    CV: PDF compiled from LaTeX
	...
	|    Studying: (Pre)Calculus, FP, CCNA
	| more at meow.uz
	mail me at meow@meow.uz
```
{% end %}

<!-- You can mail me at [meow@meow.uz](mailto:meow@meow.uz), or use matrix when urgent [@msft:floss.uz](matrix.to/#/@msft:floss.uz). -->
